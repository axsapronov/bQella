...
Reloads the current set source. \hypertarget{classraEdit_a8ba687ccd78c096ef0b9577a8238bb3f}{
\index{raEdit@{raEdit}!setSource@{setSource}}
\index{setSource@{setSource}!raEdit@{raEdit}}
\subsubsection[{setSource}]{\setlength{\rightskip}{0pt plus 5cm}void raEdit::setSource (
\begin{DoxyParamCaption}
\item[{const QUrl \&}]{url}
\end{DoxyParamCaption}
)}}
...
+! Загруженный текстовый файл -\/ это сноска (примечание) if (isVisible()) \{ QString firstTag = txt.left(txt.indexOf(QChar('$>$')) + 1); if (firstTag.left(3) == QString(\char`\"{}$<$qt\char`\"{}) \&\& firstTag.contains(QString(\char`\"{}type\char`\"{})) \&\& firstTag.contains(QString(\char`\"{}detail\char`\"{}))) \{ \#ifndef QT\_\-NO\_\-WHATSTHIS QWhatsThis::showText(QCursor::pos(), txt, q); \#endif return; \} \} 
